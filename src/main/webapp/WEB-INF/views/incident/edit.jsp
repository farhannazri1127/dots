        ...
        <header id="header" class="header d-flex align-items-center">
            ...
            <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                <a href="#" class="logo d-flex align-items-center">
                    <h1>GRATS<span>.</span> | Incident - ${incident.ticketNo}</h1>
                </a>
            </div>
        </header>
        <div class="sample-form">
            ...
            <div class="tab-content" id="ex-with-icons-content">
                <div class="tab-pane fade show active" id="ex-with-icons-tabs-1" role="tabpanel" aria-labelledby="ex-with-icons-tab-1">
                    ...
                    <form id="bs_form" class="sample-form needs-validation" role="form" action="${contextPath}/incident/update" method="post" enctype="multipart/form-data" novalidate>

                        <div class="col-lg-2">
                            <div class="form-outline mb-3 col-lg-1">
                                <input type="text" id="id" name ="id" class="form-control" value="${incident.id}" hidden>
                                <input type="text" id="groupId" name ="groupId" class="form-control" value="${GroupID}" hidden>
                                <input type="text" id="incidentNo" name ="incidentNo" class="form-control" value="${incident.ticketNo}" readonly>
                                <label class="form-label" for="incidentNo">Ticket No</label>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col">
                                <div class="form-outline">
                                    <input type="text" id="user" name ="user" class="form-control" value="${incident.user}" readonly>
                                    <label class="form-label" for="user">Requestor</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-outline">
                                    <input type="text" id="site" name ="site" class="form-control" value="${incident.site}" readonly>
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="title" name ="title" class="form-control" value="${incident.title}" disabled>
                            <label class="form-label" for="title">Title</label>
                        </div>

                        <!-- Message input -->
                        <div class="form-outline mb-4">
                            <textarea class="form-control" id="description" name="description" rows="4" disabled>${incident.description}</textarea>
                            <label class="form-label" for="description">Description</label>
                        </div>
                                
                                <!-- Text input -->
                        <div class="form-outline mb-4">
                            <input type="text" id="cc" name ="cc" class="form-control" value="${incident.cc}" disabled>
                        ...
                        <c:if test="${GroupID == '1' && incident.flag == '0'}">
                            <div class="row form-group mb-4">

                                <div class="col-lg-3">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="bi bi-calendar2-month"></i></span>
                                        <input type="text" name="eta" class="form-control" id="eta" value="${incident.eta}">
                                    </div>
                        ...
                        <c:if test="${GroupID != '1' || incident.flag == '1'}">
                            <div class="row form-group mb-4">
                                <div class="col-lg-3">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="bi bi-calendar2-month"></i></span>
                                        <input type="text" name="eta" class="form-control" id="eta" value="${incident.eta}" disabled>
                                    </div>
                                    <label id="datepickerDate-error" class="error" for="eta" style="display: none;"></label>
                                    <label for="eta" class="form-label">Estimate Completion Date</label>
                                </div>
                            ...
                            <tbody>
                                <c:forEach items="${attachment}" var="whRequest" varStatus="whRequestLoop">
                                    <tr>
                                        ...
                                        <!--<td><c:out value="${whRequest.createdDate}"/></td>-->
                                        <td class="col-lg-1">
                                            <a href="${contextPath}/incident/downloadAttach/${whRequest.id}" id="donwloadAtt" name="donwloadAtt" class="table-link" title="Download">
