                    ...
                    <div class="main-box">
                        ...
                        <form id="update_hardwareinventory_form" class="form-horizontal" role="form" action="${contextPath}/do/request/intervalCheck" method="post" style="width: 100%">
                            ...
                            <div class="form-group col-lg-11" >
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" id="rms_event" name="rms_event" placeholder="Scan Barcode" autofocus="" value="${rmsEvent}">
                                </div>
                            </div>
                            <div class="form-group col-lg-11" >
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="hidden" class="form-control" id="reqId" name="reqId" value="${reqId}">
                                </div>
                            </div> 
                            <div class="col-lg-12">
                                <br/>
                                ...
                                <tbody>
                                    <c:forEach items="${retrieveQueryList}" var="whRequest" varStatus="whRetrieveLoop">
                                        <tr>
                                            ...
                                            <td><c:out value="${whRequest.dispoRemarks}"/></td>
                                            <td class = "col-lg-1" align="left">
                                                <c:choose>
                                                    <c:when test="${groupId == '1' || groupId== '2' || groupId== '29'}">
                                                        <a href="${contextPath}/disposition/edit/${whRequest.id}/${reqId}" id="disposition" class="table-link" title="Disposition">
                                                            <span class="fa-stack">
