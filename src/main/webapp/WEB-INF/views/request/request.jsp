                                ...
                                <tbody>
                                    <c:forEach items="${requestList}" var="request" varStatus="requestLoop">
                                        <tr>
                                            ...
                                            <td align="left" >
                                                <c:choose>
                                                    <c:when test="${request.preVmId == null}">
                                                        <a href="${contextPath}/do/preVm/add/${request.id}" class="table-link" title="Pre VM">
                                                            <span class="fa-stack">
                                                    ...
                                                    <c:otherwise>
                                                        <a href="${contextPath}/do/preVm/edit/${request.preVmId}" class="table-link" title="Pre VM">
                                                            <span class="fa-stack">
                                                                <i class="fa fa-square fa-stack-2x"></i>
                                                                <i class="fa fa-eye fa-stack-1x fa-inverse"></i>
                                                            </span>
                                                ...
                                                <c:choose>
                                                    <c:when test="${request.status == 'Pending Shipment'}">
                                                    ...
                                                    <c:otherwise>
                                                        <a modaldeleteid="${request.id}" title="Add to DO list" class="table-link" style="color: silver" onclick="return false;">
                                                            <span class="fa-stack">
                                                                <i class="fa fa-square fa-stack-2x"></i>
                                                                <i class="fa fa-plus fa-stack-1x fa-inverse"></i>
                                                            </span>
