            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="main-box">
                        ...
                        <form id="edit_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/lotPenang/newIntervalUpdate" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">                                      
                                    <select id="chamberLevel" name="chamberLevel" class="js-example-basic-single" style="width: 100%">
                                        <option value="" selected=""></option>
                            ...
                            <div class="form-group">
                                <label for="testCondition" class="col-lg-2 control-label">Booking Condition</label>
                                <div class="col-lg-3">                                      
                                    <select id="testCondition" name="testCondition" class="js-example-basic-single" style="width: 100%">
                                        <option value="" selected=""></option>
                            ...
                            <a href="${contextPath}/lotPenang/newInterval/${oldLotPenangId}" class="btn btn-info pull-left"><i class="fa fa-reply"></i> Back</a>
