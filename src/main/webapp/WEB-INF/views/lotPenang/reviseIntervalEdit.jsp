            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="main-box">
                        ...
                        <form id="edit_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/lotPenang/reviseIntervalUpdate" method="post" enctype="multipart/form-data">
                            ...
                            <a href="${contextPath}/lotPenang/reviseInterval/${oldLotPenangId}" class="btn btn-info pull-left"><i class="fa fa-reply"></i> Back</a>
