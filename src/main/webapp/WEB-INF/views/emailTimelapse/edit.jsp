            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        ...
                        <form id="add_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/timelapse/emailTimelapse/update" method="post">
                            ...
                            <a href="${contextPath}/timelapse/emailTimelapse" class="btn btn-info pull-left"><i class="fa fa-reply"></i> Back</a>
