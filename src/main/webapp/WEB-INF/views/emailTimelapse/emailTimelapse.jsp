                    ...
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            ...
                            <div class="filter-block pull-right">
                                <a href="${contextPath}/timelapse/emailTimelapse/add" class="btn btn-primary pull-right">
                        ...
                        <div class="table-responsive">
                            <table id="dt_spml" class="table">
                                ...
                                <tbody>
                                    <c:forEach items="${emailTimelapseList}" var="emailConfig" varStatus="emailConfigtLoop">
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="${contextPath}/timelapse/emailTimelapse/edit/${emailConfig.id}" class="table-link" title="Edit">
                                                    <span class="fa-stack">
    ...
    <s:layout-component name="page_js_inline">
        <script>
                                                        $(document).ready(function () {
                                                            ...
                                                            var exportTitle = "Email Time-lapse List";
                                                        ...
                                                        function modalDelete(e) {
                                                            ...
                                                            var deleteUrl = "${contextPath}/timelapse/emailTimelapse/delete/" + deleteId;
