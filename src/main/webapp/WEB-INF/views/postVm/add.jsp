            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="main-box">
                        ...
                        <form id="edit_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/lotPenang/postVm/save" method="post">
                            <input type="hidden" name="requestId" value="${request.id}" />
                            <input type="hidden" name="lotPenangId" value="${lotPenangId}" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">                                      
                                    <select id="quantityMatch" name="quantityMatch" class="js-example-basic-single" style="width: 100%">
                                        ...
                                        <c:forEach items="${match}" var="group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="5" id="vmMixRemarks" name="vmMixRemarks"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="5" id="vmDemountRemarks" name="vmDemountRemarks"></textarea>
                                    <small id="noteBsEmail" class="form-text text-muted">150 Character only</small>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="5" id="vmBrokenRemarks" name="vmBrokenRemarks"></textarea>
                                    <small id="noteBsEmail" class="form-text text-muted">150 Character only</small>
                                </div>
                            </div>
