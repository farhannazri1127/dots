...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Post VM After Shipment</h1>
            <div class="row">
                <div class="col-lg-10">
                    <div class="main-box">
                        <h2>RMS Information</h2>
                        <form id="edit_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/lotPenang/postVm/update" method="post">
                            <input type="hidden" name="requestId" value="${postVm.requestId}" />
                            <input type="hidden" name="id" value="${postVm.id}" />
                            <input type="hidden" name="lotPenangId" value="${postVm.lotPenangId}" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" name="doNumber" class="form-control" id="doNumber" value="${request.doNumber}" disabled>
                                </div>
                                <label for="gts" class="col-lg-1 control-label">GTS Number </label>
                                <div class="col-lg-2">
                                    <input type="text" name="gts" class="form-control" id="gts" value="${request.gts}" disabled>
                                </div>
                            </div>
                            <hr class="separator">
                            <h2>Pre VM</h2>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="5" id="vmMixRemarks" name="vmMixRemarks">${postVm.vmMixRemarks}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="5" id="vmDemountRemarks" name="vmDemountRemarks">${postVm.vmDemountRemarks}</textarea>
                                    <small id="noteBsEmail" class="form-text text-muted">150 Character only</small>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <textarea class="form-control" rows="5" id="vmBrokenRemarks" name="vmBrokenRemarks">${postVm.vmBrokenRemarks}</textarea>
                                    <small id="noteBsEmail" class="form-text text-muted">150 Character only</small>
                                </div>
                            </div>
                            <div class="form-group" id="remarksTtdiv">
                                ...
                                <div class="col-lg-11">
                                    <textarea class="form-control" rows="5" id="remarks" name="remarks">${postVm.remarks}</textarea>
                                    <small id="noteBsEmail" class="form-text text-muted">150 Character only</small>
                                </div>
                            </div>
