                    ...
                    <div class="main-box">
                        ...
                        <form id="edit_limit_form" class="form-horizontal" role="form" action="${contextPath}/admin/uslTimelapse/update" method="post">
                            ...
                            <div class="form-group">
                                <label for="process" class="col-lg-4 control-label">Process *</label>
                                <div class="col-lg-3">
                                    <input class="form-control" id="process" name="process" value="${uslTimelapse.process}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="hour" class="col-lg-4 control-label">Hour Limit *</label>
                                <div class="col-lg-3">
