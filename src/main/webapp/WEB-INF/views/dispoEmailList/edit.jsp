            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        ...
                        <form id="add_hardwarequest_form" class="form-horizontal" role="form" action="${contextPath}/admin/dispoEmailList/update" method="post">
                            <input type="hidden" name="id" value="${emailConfig.id}" />
                            <div class="form-group">
                                <label for="distList" class="col-lg-3 control-label">Dist List </label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="distList" name="distList"  value="${emailConfig.distList}" readonly >
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="oncid" class="col-lg-3 control-label">User*</label>
                                <div class="col-lg-8">
