...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Disposition Email Management</h1>
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            <h2 class="pull-left">Disposition Email Management List</h2>

                            <div class="filter-block pull-right">
                                <a href="${contextPath}/admin/dispoEmailList/add" class="btn btn-primary pull-right">
                                    <i class="fa fa-plus-circle fa-lg"></i> Add New email
                                </a>
                            </div>
                        </div>
                        <hr/>
                                ...
                                <tbody>
                                    <c:forEach items="${emailConfigList}" var="emailConfig" varStatus="emailConfigtLoop">
                                        <tr>
                                            ...
                                            <td><c:out value="${emailConfig.distList}"/></td>
                                            <td><c:out value="${emailConfig.name}"/></td>
                                            <td id="modal_delete_info_${emailConfig.id}"><c:out value="${emailConfig.email}"/></td>
                                            <td align="center">
                                                <a href="${contextPath}/admin/dispoEmailList/edit/${emailConfig.id}" class="table-link" title="Edit">
                                                    <span class="fa-stack">
    ...
    <s:layout-component name="page_js_inline">
        <script>
                                                        ...
                                                        function modalDelete(e) {
                                                            ...
                                                            var deleteUrl = "${contextPath}/admin/dispoEmailList/delete/" + deleteId;
