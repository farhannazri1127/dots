...
public class LotPenangPdf extends AbstractITextPdfViewPotrait {
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document doc,
        ...
        Request request1 = (Request) model.get("req");
        ...
        if (lotPenang.getOldLotPenangId() != null) {
            cellHeader.setPhrase(new Phrase("Previous Interval", fontHeader));
            table.addCell(cellHeader);
            cellContent.setPhrase(new Phrase(request1.getInterval(), fontContent));
            table.addCell(cellContent);
        ...
        cellHeader.setPhrase(new Phrase("Unloading Quantity", fontHeader));
        table.addCell(cellHeader);
        cellContent.setPhrase(new Phrase(lotPenang.getUnloadingQty(), fontContent));
        table.addCell(cellContent);
