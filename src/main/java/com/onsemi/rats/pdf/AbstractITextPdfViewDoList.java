...
public abstract class AbstractITextPdfViewDoList extends AbstractView {

    public AbstractITextPdfViewDoList() {
    ...
    class TableHeader extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            try {
                ...
                cellTitle.setPhrase(new Phrase("", fontOpenSans(12f, Font.BOLD)));
                ...
                cellPageOf.setBorder(Rectangle.NO_BORDER);
                ...
                cellFooter.setPhrase(new Phrase("", fontOpenSans(6f, Font.NORMAL)));
