        ...
        <header id="header" class="header d-flex align-items-center">
            ...
            <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                <a href="${contextPath}/" class="logo d-flex align-items-center">
                    ...
                    <h1>Reliability Apps Ticketing System (RATS)<span>.</span></h1>
                </a>
                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-md-9 col-lg-6 col-xl-5">
                        <img src="${contextPath}/resources/img/clipart633480.png"
                             class="img-fluid" alt="RATS">
                    </div>
                    <div class="col-md-7 col-lg-5 col-xl-4 offset-xl-1">
                        <div class="divider d-flex align-items-center my-4">
                            <p class="text-center fw-bold mx-3 mb-0">Reliability Apps Ticketing System</p>
                        </div>
                        <form action="${contextPath}/register/add" method="post">
                            <!-- Email input -->
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="loginId" name="loginId" placeholder="name@example.com">
